    ...
    >
      <div className={styles['container']}>
        <Link to="/" className={styles['navlink']}>
          <h1 className={styles['Heading']}>{props.heading1}</h1>
        </Link>
        <div className={styles['container1']}>
          <Link to="/a-b-o-u-t-u-s" className={styles['navlink1']}>
            {props.about}
          </Link>
        </div>
        <div className={styles['container2']}>
          <span className={styles['text']}>{props.acad}</span>
        </div>
      </div>
...
Header.defaultProps = {
  ...
  acad: 'ACADEMICS',
  about: 'ABOUT US',
  heading1: 'SAINT ANTHONY ES',
}

Header.propTypes = {
  rootClassName: PropTypes.string,
  heading11: PropTypes.string,
  acad: PropTypes.string,
