...
import styles from './a-b-o-u-t-u-s.module.css'

const ABOUTUS = (props) => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>ABOUT US - Saint Anthony ES</title>
        <meta property="og:title" content="ABOUT US - Saint Anthony ES" />
      </Helmet>
      <div className={styles['Hero']}>
        ...
        <div className={styles['Container01']}>
          ...
          >
            <span className={styles['text01']}>Discover the School</span>
          </button>
          <img
            alt="image"
      ...
      <div className={styles['Section1']}>
        <div className={styles['container04']}>
          <div className={styles['Container05']}>
            <h6 className={styles['text02']}>
              <span>WITH BURNED SOLES</span>
              <span></span>
            </h6>
            <h3
              className={` ${styles['text05']} ${projectStyles['headings']} `}
            >
          ...
          <div className={styles['WorkWithUs']}>
            <div className={styles['container09']}>
              ...
              <h3
                className={` ${styles['text14']} ${projectStyles['headings']} `}
              >
              ...
              <span className={styles['text20']}>Check Notus PRO React!</span>
            </div>
            <div className={styles['container11']}>
              ...
              <div className={styles['container13']}>
                <h4
                  className={` ${styles['text21']} ${projectStyles['headings']} `}
                >
                  <span className={styles['text22']}>Top Notch Services</span>
                  <br></br>
                </h4>
      ...
      <div className={styles['Section2']}>
        <div className={styles['container14']}>
          ...
          <h2 className={` ${styles['text25']} ${projectStyles['text2XL']} `}>
            <span className={styles['text26']}>
              You need to fight like David with Goliath
            </span>
            <br></br>
          </h2>
          <span className={` ${styles['text27']} ${projectStyles['textXL']} `}>
        ...
        <div className={styles['GrowingCompanySection']}>
          ...
          <div className={styles['container15']}>
            ...
            <h3
              className={` ${styles['text28']} ${projectStyles['headings']} `}
            >
              A growing company
            </h3>
            ...
            <div className={styles['container19']}>
              ...
              <span className={styles['text31']}>Amazing page examples</span>
            </div>
            <div className={styles['container21']}>
              ...
              <span className={styles['text32']}>Dynamic components</span>
            </div>
          </div>
        </div>
        <div className={styles['container23']}>
          <h6 className={styles['text33']}>
            <span>THE ENTOURAGE</span>
          </h6>
          <h3 className={` ${styles['text35']} ${projectStyles['headings']} `}>
            It is everything, and it won&apos;t change
          </h3>
          <span className={` ${styles['text36']} ${projectStyles['textXL']} `}>
      ...
      <div className={styles['Section3']}>
        <div className={styles['container45']}>
          <h6 className={` ${styles['text38']} ${projectStyles['textSM']} `}>
            <span>ON THE COASTLINE</span>
          </h6>
          <h3 className={` ${styles['text40']} ${projectStyles['headings']} `}>
            We are missing the summer
          </h3>
          <span className={` ${styles['text41']} ${projectStyles['textXL']} `}>
          ...
          <div className={styles['Services']}>
            ...
            <div className={styles['container48']}>
              ...
              <h1
                className={` ${styles['text45']} ${projectStyles['textXL']} `}
              >
                Launch time
              </h1>
          ...
          <div className={styles['Contact']}>
            ...
            <h2 className={styles['text47']}>Type in the bellow form</h2>
            <span
            ...
            <div className={styles['Form']}>
              <h1 className={styles['text49']}>Want to work with us?</h1>
              <span
                className={` ${styles['text50']} ${projectStyles['textXL']} `}
              >
              ...
              />
              <span
                className={` ${styles['text52']} ${projectStyles['textXS']} `}
              >
                EMAIL
              </span>
              <input
              ...
              />
              <span
                className={` ${styles['text53']} ${projectStyles['textXS']} `}
              >
                MESSAGE
              </span>
              <textarea
