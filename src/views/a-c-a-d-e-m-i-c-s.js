...
import styles from './a-c-a-d-e-m-i-c-s.module.css'

const ACADEMICS = (props) => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>ACADEMICS - Saint Anthony ES</title>
        <meta property="og:title" content="ACADEMICS - Saint Anthony ES" />
      </Helmet>
      ...
      <div className={styles['Section1']}>
        <div className={styles['container04']}>
          <div className={styles['Container05']}>
            ...
            <h3
              className={` ${styles['text09']} ${projectStyles['headings']} `}
            >
          ...
          <div className={styles['WorkWithUs']}>
            <div className={styles['container09']}>
              ...
              <h3
                className={` ${styles['text18']} ${projectStyles['headings']} `}
              >
              ...
              <span className={styles['text24']}>Check Notus PRO React!</span>
            </div>
            <div className={styles['container11']}>
              ...
              <div className={styles['container13']}>
                <h4
                  className={` ${styles['text25']} ${projectStyles['headings']} `}
                >
                  <span className={styles['text26']}>Top Notch Services</span>
                  <br></br>
                </h4>
      ...
      <div className={styles['Section2']}>
        <div className={styles['container14']}>
          ...
          <h2 className={` ${styles['text29']} ${projectStyles['text2XL']} `}>
        ...
        <div className={styles['GrowingCompanySection']}>
          ...
          <div className={styles['container15']}>
            ...
            <h3
              className={` ${styles['text32']} ${projectStyles['headings']} `}
            >
              A growing company
            </h3>
            ...
            <div className={styles['container19']}>
              ...
              <span className={styles['text35']}>Amazing page examples</span>
            </div>
            <div className={styles['container21']}>
              ...
              <span className={styles['text36']}>Dynamic components</span>
            </div>
          </div>
        </div>
        <div className={styles['container23']}>
          <h6 className={styles['text37']}>
            <span>THE ENTOURAGE</span>
          </h6>
          <h3 className={` ${styles['text39']} ${projectStyles['headings']} `}>
            It is everything, and it won&apos;t change
          </h3>
          <span className={` ${styles['text40']} ${projectStyles['textXL']} `}>
      ...
      <div className={styles['Section3']}>
        <div className={styles['container45']}>
          <h6 className={` ${styles['text42']} ${projectStyles['textSM']} `}>
            <span>ON THE COASTLINE</span>
          </h6>
          <h3 className={` ${styles['text44']} ${projectStyles['headings']} `}>
            We are missing the summer
          </h3>
          <span className={` ${styles['text45']} ${projectStyles['textXL']} `}>
          ...
          <div className={styles['Services']}>
            ...
            <div className={styles['container46']}>
              ...
              <h1
                className={` ${styles['text47']} ${projectStyles['textXL']} `}
              >
                Grow your market
              </h1>
            ...
            <div className={styles['container48']}>
              ...
              <h1
                className={` ${styles['text49']} ${projectStyles['textXL']} `}
              >
                Launch time
              </h1>
          ...
          <div className={styles['Contact']}>
            ...
            <h2 className={styles['text51']}>Type in the bellow form</h2>
            <span
              className={` ${styles['text52']} ${projectStyles['textXL']} `}
            >
            ...
            <div className={styles['Form']}>
              <h1 className={styles['text53']}>Want to work with us?</h1>
              <span
                className={` ${styles['text54']} ${projectStyles['textXL']} `}
              >
                Complete this form and we will get back to you in 24 hours.
              </span>
              <span
                className={` ${styles['text55']} ${projectStyles['textXS']} `}
              >
                FULL NAME
              </span>
              <input
              ...
              />
              <span
                className={` ${styles['text56']} ${projectStyles['textXS']} `}
              >
                EMAIL
              </span>
              <input
              ...
              />
              <span
                className={` ${styles['text57']} ${projectStyles['textXS']} `}
              >
                MESSAGE
              </span>
              <textarea
