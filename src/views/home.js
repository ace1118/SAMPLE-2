...
const Home = (props) => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>Saint Anthony ES</title>
        <meta property="og:title" content="Saint Anthony ES" />
      </Helmet>
      <div className={styles['Hero']}>
        ...
        <div className={styles['Container01']}>
          <img
            alt="image"
            src="/playground_assets/saes%20logo-200w.png"
            className={styles['image']}
          />
          <div className={styles['container02']}>
            <h1 className={` ${styles['text']} ${projectStyles['welcome']} `}>
              <span>
                WELCOME
                <span
          ...
          >
            <span className={styles['text05']}>Discover the School</span>
          </button>
          <img
            alt="image"
          ...
          <img
            alt="image"
            src="https://images.unsplash.com/photo-1497633762265-9d179a990aa6?ixid=Mnw5MTMyMXwwfDF8c2VhcmNofDF8fFNDSE9PTHxlbnwwfHx8fDE2NDcwOTQ2MTE&amp;ixlib=rb-1.2.1&amp;w=1500"
      ...
      <div className={styles['Section1']}>
        <div className={styles['container04']}>
          <div className={styles['Container05']}>
            ...
            >
              <span className={styles['text09']}>
                We do everything to ensure the health, safety and well-being of
                our pupils, parents, teachers, and non-teaching staff. For
                in-site visits you may accomplish the iProtect Health Form
          ...
          <iframe
            src="https://docs.google.com/forms/d/e/1FAIpQLSe5hiGT7evj52K2leGtcZH8zldPfKlMO3er2UEbgiOhwAlnPw/viewform?usp=sf_link"
            className={styles['Iframe']}
          ></iframe>
          <div className={styles['container07']}></div>
          <img
            alt="image"
            src="/playground_assets/iprotect-200w.png"
          ...
          <div className={styles['WorkWithUs']}>
            <div className={styles['container08']}>
              ...
              <h3
                className={` ${styles['text10']} ${projectStyles['headings']} `}
              >
              ...
              <span className={styles['text16']}>Check Notus PRO React!</span>
            </div>
            <div className={styles['container10']}>
              ...
              <div className={styles['container12']}>
                <h4
                  className={` ${styles['text17']} ${projectStyles['headings']} `}
                >
                  <span className={styles['text18']}>Top Notch Services</span>
                  <br></br>
                </h4>
      ...
      <div className={styles['Section2']}>
        <div className={styles['container13']}>
          ...
          <h2 className={` ${styles['text21']} ${projectStyles['text2XL']} `}>
            <span className={styles['text22']}>
              You need to fight like David with Goliath
            </span>
            <br></br>
          </h2>
          <span className={` ${styles['text23']} ${projectStyles['textXL']} `}>
        ...
        <div className={styles['GrowingCompanySection']}>
          ...
          <div className={styles['container14']}>
            ...
            <h3
              className={` ${styles['text24']} ${projectStyles['headings']} `}
            >
              A growing company
            </h3>
            ...
            <div className={styles['container18']}>
              ...
              <span className={styles['text27']}>Amazing page examples</span>
            </div>
            <div className={styles['container20']}>
              ...
              <span className={styles['text28']}>Dynamic components</span>
            </div>
          </div>
        </div>
        <div className={styles['container22']}>
          <h6 className={styles['text29']}>
            <span>THE ENTOURAGE</span>
          </h6>
          <h3 className={` ${styles['text31']} ${projectStyles['headings']} `}>
            It is everything, and it won&apos;t change
          </h3>
          <span className={` ${styles['text32']} ${projectStyles['textXL']} `}>
            ...
            <div className={styles['container33']}>
              ...
              <div className={styles['container34']}>
                ...
                <div className={styles['container36']}>
                  <svg viewBox="0 0 1024 1024" className={styles['icon23']}>
                    <path d="M783.104 239.957c-74.667-74.283-165.888-111.957-271.104-111.957-106.197 0-197.675 37.717-271.915 112-74.368 74.283-112.085 165.845-112.085 272 0 105.173 37.675 196.395 111.957 271.104 74.283 74.923 165.803 112.896 272.043 112.896 105.259 0 196.48-37.973 271.189-112.768 74.88-74.795 112.811-166.059 112.811-271.232 0-106.155-37.973-197.717-112.896-272.043zM722.859 722.901c-48.512 48.597-103.936 76.288-168.192 84.693v-210.261h85.333v-85.333h-85.333v-59.733c0-14.123 11.477-25.6 25.643-25.6h59.691v-85.333h-59.605c-31.659 0-58.069 11.648-79.232 35.072-21.163 23.339-31.829 51.84-31.829 85.675v49.92h-85.333v85.333h85.333v210.347c-64.939-8.32-120.576-36.053-168.832-84.651-58.667-59.051-87.168-128.085-87.168-211.029 0-83.883 28.459-153.088 87.125-211.627 58.453-58.581 127.659-87.040 211.541-87.040 82.987 0 151.979 28.501 210.987 87.168 59.008 58.539 87.68 127.744 87.68 211.499 0 82.816-28.715 151.851-87.808 210.901z"></path>
                  </svg>
                </div>
      ...
      <div className={styles['Section3']}>
        <div className={styles['container44']}>
          <h6 className={` ${styles['text34']} ${projectStyles['textSM']} `}>
            <span>ON THE COASTLINE</span>
          </h6>
          <h3 className={` ${styles['text36']} ${projectStyles['headings']} `}>
            We are missing the summer
          </h3>
          <span className={` ${styles['text37']} ${projectStyles['textXL']} `}>
          ...
          <div className={styles['Services']}>
            ...
            <div className={styles['container45']}>
              ...
              <h1
                className={` ${styles['text39']} ${projectStyles['textXL']} `}
              >
                Grow your market
              </h1>
          ...
          <div className={styles['Contact']}>
            ...
            <h2 className={styles['text43']}>Type in the bellow form</h2>
            <span
              className={` ${styles['text44']} ${projectStyles['textXL']} `}
            >
            ...
            <div className={styles['Form']}>
              <h1 className={styles['text45']}>Want to work with us?</h1>
              <span
              ...
              <span
                className={` ${styles['text47']} ${projectStyles['textXS']} `}
              >
                FULL NAME
              </span>
              <input
              ...
              />
              <span
                className={` ${styles['text48']} ${projectStyles['textXS']} `}
              >
                EMAIL
              </span>
              <input
